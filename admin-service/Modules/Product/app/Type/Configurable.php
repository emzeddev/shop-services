...
use Modules\Admin\Validations\ConfigurableUniqueSku;
use Modules\Checkout\Models\CartItem as CartItemModel;
use Modules\Product\DataTypes\CartItemValidationResult;
use Modules\Product\Facades\ProductImage;
use Modules\Product\Helpers\Indexers\Price\Configurable as ConfigurableIndexer;
use Modules\Tax\Facades\Tax;
...
class Configurable extends AbstractType
{
     ...
     *
     * @param  \Modules\Checkout\Contracts\CartItem  $cartItem
     * @return bool
     */
     ...
     *
     * @param  \Modules\Customer\Contracts\Wishlist  $item
     * @return bool
     */
    ...
    {
        $childProduct = app('Modules\Product\Repositories\ProductRepository')->find($data['selected_configurable_option']);
     ...
     * @return \Modules\Checkout\Contracts\CartItem|\Modules\Sales\Contracts\OrderItem|\Modules\Sales\Contracts\InvoiceItem|\Modules\Sales\Contracts\ShipmentItem|\Modules\Customer\Contracts\Wishlist
     */
     ...
     *
     * @param  \Modules\Customer\Contracts\Wishlist|\Modules\Checkout\Contracts\CartItem  $item
     * @return array
     */
    public function getBaseImage($item)
    {
        ...
        if ($item instanceof \Modules\Customer\Contracts\Wishlist) {
     ...
     *
     * @param  \Modules\Product\Type\CartItem  $item
     */
