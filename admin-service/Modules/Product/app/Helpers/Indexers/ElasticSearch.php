...
namespace Modules\Product\Helpers\Indexers;

use Elastic\Elasticsearch\Exception\ClientResponseException;
use Modules\Attribute\Repositories\AttributeRepository;
use Modules\Core\Facades\ElasticSearch as ElasticSearchClient;
...
class ElasticSearch extends AbstractIndexer
{
     ...
     * Locale instance.
     *
     * @var \Modules\Core\Contracts\Locale
     */
    protected $locale;
     ...
     * @return \Modules\Product\Helpers\Indexers\ElasticSearch\Product
     */
     ...
     * @param  \Modules\Product\Contracts\ProductAttributeValue
     * @return void
     */
