...
use Modules\CatalogRule\Models\CatalogRuleProduct;

use Modules\CatalogRule\Contracts\CatalogRuleProductPrice as CatalogRuleProductPriceContract;
use Modules\CatalogRule\Models\CatalogRuleProductPrice;

class CatalogRuleServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'CatalogRule';

    protected string $nameLower = 'catalogrule';
    ...
    public function registerModelProxies() {
        $this->app->concord->registerModel(
            CatalogRuleContract::class,
            CatalogRule::class
        );

        $this->app->concord->registerModel(
            CatalogRuleProductContract::class,
            CatalogRuleProduct::class
        );

        $this->app->concord->registerModel(
            CatalogRuleProductPriceContract::class,
