...
use Modules\CMS\DataGrids\CMSPageDataGrid;
use App\Http\Controllers\Controller;
use Modules\CMS\Http\Requests\MassDestroyRequest;
    ...
    */
    ...
    public function store()
    {
        $this->validate(request(), [
            'url_key'      => ['required', 'unique:cms_page_translations,url_key', new \Modules\Core\Rules\Slug],
            'page_title'   => 'required',
            'channels'     => 'required',
    ...
    public function update(int $id)
    {
        ...
        $this->validate(request(), [
            $locale.'.url_key'      => ['required', new \Modules\Core\Rules\Slug, function ($attribute, $value, $fail) use ($id) {
