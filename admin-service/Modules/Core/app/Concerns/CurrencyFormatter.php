...
use Modules\Core\Contracts\Currency;
...
trait CurrencyFormatter
{
     ...
     *
     * @param  string|\Modules\Core\Contracts\Currency  $currency
     */
    public function currencySymbol($currency): string
    {
        $code = $currency instanceof \Modules\Core\Contracts\Currency ? $currency->code : $currency;
