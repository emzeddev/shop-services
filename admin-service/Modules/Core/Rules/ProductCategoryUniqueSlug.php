...
use Modules\Category\Models\CategoryTranslationProxy;
...
class ProductCategoryUniqueSlug implements Rule
{
    ...
    public function message()
    {
        if ($this->isSlugReserved) {
            return trans('category::app.validations.slug-reserved');
        }

        return trans('category::app.validations.slug-being-used');
    }
