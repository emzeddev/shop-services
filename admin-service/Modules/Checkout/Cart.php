...
use Modules\Checkout\Exceptions\BillingAddressNotFoundException;
use Modules\Checkout\Models\CartAddress;
use Modules\Checkout\Models\CartPayment;
use Modules\Checkout\Repositories\CartAddressRepository;
...
class Cart
{
     ...
     * The cart instance.
     *
     * @var \Modules\Checkout\Contracts\Cart
     */
    private $cart;
