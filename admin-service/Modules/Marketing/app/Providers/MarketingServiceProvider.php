...
use Modules\Marketing\Contracts\Campaign as CampaignContract;
use Modules\Marketing\Models\Campaign;

use Modules\Marketing\Contracts\Event as EventContract;
use Modules\Marketing\Models\Event;

use Modules\Marketing\Contracts\SearchSynonym as SearchSynonymContract;
use Modules\Marketing\Models\SearchSynonym;

use Modules\Marketing\Contracts\SearchTerm as SearchTermContract;
use Modules\Marketing\Models\SearchTerm;

use Modules\Marketing\Contracts\Template as TemplateContract;
use Modules\Marketing\Models\Template;

use Modules\Marketing\Contracts\URLRewrite as URLRewriteContract;
use Modules\Marketing\Models\URLRewrite;
...
class MarketingServiceProvider extends ServiceProvider
{
    ...
    public function registerModelProxies() {
        ...
        $this->app->concord->registerModel(
            SearchSynonymContract::class,
            SearchSynonym::class
        );  

        $this->app->concord->registerModel(
            SearchTermContract::class,
            SearchTerm::class
        );  
