...
namespace Modules\CartRule\Helpers;
...
use Modules\Rule\Helpers\Validator;
...
class CartRule
{
     ...
     *
     * @param  \Modules\CartRule\Contracts\CartRule  $rule
     */
    public function canProcessRule($rule): bool
    {
        if ($rule->coupon_type) {
            ...
            /** @var \Modules\CartRule\Models\CartRule $rule */
